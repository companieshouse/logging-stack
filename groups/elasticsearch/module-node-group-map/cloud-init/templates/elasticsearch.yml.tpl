write_files:
  - path: /etc/elasticsearch/elasticsearch.yml
    ...
    permissions: 0660
    content: |
      cluster.name: ${environment}%{ if contains(roles, "master") }
      cluster.routing.allocation.awareness.attributes: availability_zone%{ endif }
      ...
      network.host: _ec2:privateIpv4_%{ if !contains(roles, "master") }%{ if availability_zone != null }
      node.attr.availability_zone: ${availability_zone}%{ endif }%{ endif }
